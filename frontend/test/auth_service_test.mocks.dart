...
// in e_receitasus/test/auth_service_test.dart.
...
class _FakeGetClaimsResponse_22 extends _i1.SmartFake
    implements _i2.GetClaimsResponse {
  _FakeGetClaimsResponse_22(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
  ...
  _i3.Future<_i2.GetClaimsResponse> getClaims([
    ...
    _i2.GetClaimsOptions? options,
      ...
      (super.noSuchMethod(
        ...
        returnValue:
            _i3.Future<_i2.GetClaimsResponse>.value(_FakeGetClaimsResponse_22(
          this,
          Invocation.method(
            #getClaims,
            [
