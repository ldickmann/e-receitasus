...
class AuthService implements IAuthService {
  ...
  final String baseUrl = 'http://10.0.2.2:3000/api/v1/auth';

  // Injeção do cliente HTTP para TDD (permite o Mock no teste)
  AuthService({required this.client});

  /// Implementa a autenticação do usuário, comunicando com a API (Back-End VS Code).
  @override
  Future<String> login(String email, String password) async {
    ...
    if (response.statusCode == 200) {
      ...
      // Retorna o token JWT (Requisito de Segurança)
      return data['token'];
